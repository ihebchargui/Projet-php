...
<header class="navigation ">
	<nav class="navbar navbar-expand-lg main-nav py-lg-3 position-absolute w-100" id="main-nav">
		<div class="container">
          ...
          <span class="login">
            <a  href="res.php" data-hj-masked="" class="nav-link" data-analytics-location="nav" data-analytics="top-nav-login">Log In</a>
  ...
  <section class="ftco-section ftco-wrap-about">
    <div class="container">
        <div class="row">
            <div class="col-md-7 d-flex">
                <div class="img img-1 mr-md-2">
                    <img src="images/about/bg_5.jpg" alt="" class="img-fluid">
                </div>
      ...
      <div class="heading-section mb-4 my-5 my-md-0">
        ...
        <h2 class="mb-4">Omi Yammi Restaurant</h2>
      </div>
      <p>Amazing Restaurant in Sahloul Sousse since 2020 <br>
      Traditional Tunisian food 
      </p>
                <pc class="time">
                    <span>Mon - Sun <strong>8 AM - 11 PM</strong></span>
                    <br>
                    <span><h3 href="#">+21624319***</h3></span>
                </p>
            </div>
        </div>
    </div>
  ...
  <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
    <div class="media block-6 services d-block">
      ...
      <div class="media-body p-2 mt-3">
        ...
        <p>You can celebrate your birthday with us</p>
      </div>
    </div>      
  </div>
  <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
...
<section class="ftco-section img" style="background-image: url(images/about/bg_3.jpg)" data-stellar-background-ratio="0.5">
  ...
  <div class="col-md-12 ftco-animate makereservation p-4 px-md-5 pb-md-5">
      <div class="heading-section ftco-animate mb-5 text-center">
        ...
        <div class="col-md-12 mt-3" onclick="remove_class()">
          <div class="form-group text-center">
            <a href="res.php" type="submit"  class="btn btn-primary py-3 px-5" >BOOK A TABLE</a>
          </div>
        </div>
      </div>
  </div>
